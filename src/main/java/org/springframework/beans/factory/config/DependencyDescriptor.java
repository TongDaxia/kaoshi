...
public class DependencyDescriptor extends InjectionPoint implements Serializable {
	 ...
	 */
	public DependencyDescriptor(org.springframework.beans.factory.config.DependencyDescriptor original) {
		super(original);
	...
	public org.springframework.beans.factory.config.DependencyDescriptor forFallbackMatch() {
		return new org.springframework.beans.factory.config.DependencyDescriptor(this) {
			@Override
			public boolean fallbackMatchAllowed() {
				return true;
			}
	...
	public boolean equals(@Nullable Object other) {
		...
		org.springframework.beans.factory.config.DependencyDescriptor otherDesc = (org.springframework.beans.factory.config.DependencyDescriptor) other;
