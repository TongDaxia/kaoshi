...
public class TypedStringValue implements BeanMetadataElement {
	...
	/**
	 * Create a new {@link org.springframework.beans.factory.config.TypedStringValue} for the given String value.
	...
	public boolean equals(@Nullable Object other) {
		...
		if (!(other instanceof org.springframework.beans.factory.config.TypedStringValue)) {
			return false;
		}
		org.springframework.beans.factory.config.TypedStringValue otherValue = (org.springframework.beans.factory.config.TypedStringValue) other;
